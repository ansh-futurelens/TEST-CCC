...
const MentalFitness = () => {
  const testimonials = [
    ...
    },
    {
      ...
      title:
        "Cognitive training significantly improves stress management at work",
      ...
      <div className="container-custom">
        <div className="flex flex-col justify-center text-center xl:items-center xl:text-center items-start text-left px-6 sm:px-8 md:px-10">
          ...
          <h3 className="font-sans mt-4 font-normal xl:text-[23px] lg:text-[20px] md:text-[16px] sm:text-[14px] text-xl leading-tight tracking-wide text-gray-800 max-w-5xl">
            Extensive research shows the positive linkage between cognitive
            skills training and employee performance and engagement, directly
            contributing to measurable business metrics.
          </h3>
        </div>
