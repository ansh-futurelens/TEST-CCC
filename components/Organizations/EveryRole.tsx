...
const EveryRole = () => {
    const { HEADING, SUB_HEADING, CARDS } = CONTENT_CONFIG.ORGANIZATION_PAGE.EVERY_ROLE;
                    ...
                    <div className="flex flex-wrap justify-center gap-6 w-full max-w-7xl">
                        {CARDS.map((card, i) => (
                            ...
                            >
                                ...
                                {/* Hover Overlay */}
                                <div className="absolute inset-0 bg-[#50418C]/95 
