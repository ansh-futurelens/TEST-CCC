...
const EveryRole = () => {
  ...
  const HERO = CONTENT_CONFIG.ORGANIZATION_PAGE.EVERY_ROLE.HERO;
  const CARDS = CONTENT_CONFIG.ORGANIZATION_PAGE.EVERY_ROLE.CARDS;

  return (
    <div className="everyrole-root">
      <div className="container-custom">
        <div className="everyrole-heading-wrapper">
          <h2 className="everyrole-heading-primary">{HERO.HEADING.join(" ")}</h2>
          <h6 className="everyrole-sub-heading">{HERO.SUB_HEADING.join(" ")}</h6>
        </div>

        <div className="everyrole-cards-section">
          <div className="everyrole-cards-wrapper">
            {CARDS.map((card, i) => (
              <div key={i} className="everyrole-card group">
                <LazyImage src={card.img} alt={card.title} className="everyrole-card-img" />

                <div className="everyrole-card-overlay">
                  <h2 className="everyrole-card-overlay-title">{card.title}</h2>
                  <div className="everyrole-card-overlay-points">
                    {card.points.map((point, idx) => (
                      <h3 key={idx} className="everyrole-card-overlay-point">
                        {point}
                      </h3>
                    ))}
                  </div>
                ...
                <div className="everyrole-card-title">{card.title}</div>
              </div>
            ))}
          </div>
        </div>

        <div className="everyrole-button-wrapper">
          <button className="everyrole-button" onClick={toggleModal}>
