...
// Keep FormInputField as is, no changes needed for this modification
...
const FormSelectField: React.FC<{
    ...
    const selectedOptionLabel = options.find(option => option.value === value)?.label || options[0].label;
                    ...
                    <div className="py-1">
                        {options.map((option) => (
                            <div
                                ...
                                ${option.value === '' && options[0].value === '' ? 'opacity-50 cursor-not-allowed' : ''}
                                `}
                                role="option"
...
const Experience: React.FC = () => {
    ...
    const handleChange = (e: { target: { name: string; value: string } }) => { // Adjusted parameter type
            ...
            <div className="container-custom w-full max-w-6xl">
                <div className="bg-[#F0F0F0] rounded-4xl p-6 sm:p-10 md:p-12 w-full">
                    ...
                    <h3 className=" text-gray-800 mb-8 md:mb-12 max-w-7xl mx-auto text-xl md:text-[xl]">
                        Schedule a personalized demo to learn how Q Studio's Mind Skills Training can help your organization and employees.
                    </h3>
