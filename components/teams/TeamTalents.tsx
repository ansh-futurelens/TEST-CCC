...
const TeamTalent: React.FC = () => {
  return (
    <div className="bg-[#F9F9F9] flex flex-col justify-center text-center py-16 px-4 py-16 sm:py-20 px-4 sm:px-8 md:px-10 lg:px-20">
      <h2
        className="text-xl md:text-2xl lg:text-4xl xl:text-5xl font-bold text-teal-900 mb-6 
      ...
      <div className="w-full xl:flex xl:justify-center">
        <h3
          className="text-xl sm:text-lg md:text-lg lg:text-xl xl:text-2xl text-gray-600 max-w-3xl
                   text-left sm:text-left md:text-left lg:text-left xl:text-center"
        >
          Equip your team with Mind Skills, so they not only perform, but
          thrive.
        </h3>
      </div>
      ...
      <h2
        className="text-xl md:text-lg lg:text-xl xl:text-2xl text-gray-800 text-base
               text-left sm:text-left md:text-left lg:text-left xl:text-center"
      >
        Have questions?{" "}
        <a
