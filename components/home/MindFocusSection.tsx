...
const MindFocusSection = () => {
  const { HEADING, SUB_HEADING, CARDS } =
    CONTENT_CONFIG.LANDING_PAGE.MIND_FOCUS;
              ...
              <div className="flex flex-col gap-14">
                {[
                  ...
                  },
                  {
                    ...
                    desc: "As you learn and apply Mind Skills, you will start to notice a change in your thought patterns, emotions, and responses.",
                  },
                  {
                    img: "/media/landing/fit.png",
                    title: "Fit anywhere, anytime",
                    desc: "Our app seamlessly integrates into your life. Access it anytime, anywhere whether commuting, between meetings, or unwinding at home.",
                  },
                ].map((step, index) => (
                  <div
                    key={index}
